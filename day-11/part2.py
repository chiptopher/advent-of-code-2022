...
if __name__ == '__main__':
    with open('day-11/input.txt', 'r') as source:
        ...
        for i in range(0, len(lines), 7):
            monkeys[len(monkeys)] = _parse_monkey(len(monkeys), lines[i:i+6])
        ...
        monkey_business = list(reversed(sorted(monkeys[monkey].inspection_count for monkey in monkeys)))[0:2]
